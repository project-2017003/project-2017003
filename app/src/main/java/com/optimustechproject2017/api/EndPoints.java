package com.optimustechproject2017.api;


import com.optimustechproject2017.CONST;
...
public class EndPoints {
     ...
     * Base server url.
     */
    private static final String API_URL = "http://eats.rcssastra.com/";    // staging
    ...
    public static final String USER_LOGIN_EMAIL = API_URL.concat("%d/signuppref/email");
    public static final String USER_LOGIN_FACEBOOK = API_URL.concat("%d/signuppref/facebook");
